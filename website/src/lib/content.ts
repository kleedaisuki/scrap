...
export const copy: Record<Locale, SiteCopy> = {
  zh: {
    ...
    download: {
      ...
      footnote: "所有下载均由 GitHub Releases 提供。发布页同时提供版本说明与 SHA-256 校验和。",
    },
  ...
  en: {
    ...
    download: {
      ...
      footnote: "Downloads are served by GitHub Releases, alongside release notes and SHA-256 checksums.",
    },
